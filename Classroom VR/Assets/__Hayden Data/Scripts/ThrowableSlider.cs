...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ThrowableSlider : MonoBehaviour
    {
        [EnumFlags]
        ...
        protected virtual void Awake()
        {
            ...
            this.gameObject.transform.localPosition = new Vector3(66.0f, 0.0f, 0.0f);
        ...
        protected virtual void HandAttachedUpdate(Hand hand)
        {
            ...
            newPos.y = startPos.y;
            newPos.z = startPos.z;
            newPos.x = Math.Min(startPos.x + 0.2f, newPos.x);
            newPos.x = Math.Max(startPos.x - 0.2f, newPos.x);

            float dist = 5*(newPos.x - startPos.x);
            float value = slid.maxValue * dist;
            slid.value = value;
