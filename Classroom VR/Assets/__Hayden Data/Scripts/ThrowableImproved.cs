...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ThrowableImproved : MonoBehaviour
    {
        [EnumFlags]
        ...
        protected virtual void OnHandHoverBegin(Hand hand)
        {
            ...
            if (showHint)
            {
                ControllerButtonHints.ShowTextHint(hand, SteamVR_Input.actionsIn[0], hintText);
            }
        }
        ...
        protected virtual void HandAttachedUpdate(Hand hand)
        {
            ...
            if (hand.IsGrabEnding(this.gameObject))
            {
                ...
                if (timeSinceClick < timeToGrab)
                {
                    dropDownGameObject.GetComponent<DropDown>().clicked();
                }
